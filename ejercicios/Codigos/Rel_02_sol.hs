-- I1M 2017-18: Rel_2_sol.hs (30 de septiembre de 2015)
...
ejemplos = 
  ...
  , "xor3b_e1" ~:
    xor3b True  True  ~?= False 
  , "xor3b_e2" ~:
    xor3b True  False ~?= True
  , "xor3b_e3" ~:
    xor3b False True  ~?= True
  , "xor3b_e4" ~:
    xor3b False False ~?= False

  , "xor4_e1" ~:
    xor4 True  True  ~?= False 
  , "xor4_e2" ~:
    xor4 True  False ~?= True
  , "xor4_e3" ~:
    xor4 False True  ~?= True
  , "xor4_e4" ~:
    xor4 False False ~?= False
  ...
  , "numeroDeRaices2_e1" ~:
    numeroDeRaices2 2 0 3    ~?=  0
  , "numeroDeRaices2_e2" ~:
    numeroDeRaices2 4 4 1    ~?=  1
  , "numeroDeRaices2_e3" ~:
    numeroDeRaices2 5 23 12  ~?=  2
